...
function filterMessages(originalData) {
    ...
    return nestedMessages.map((msg) => {
        ...
        const files = ((_a = msg.files) === null || _a === void 0 ? void 0 : _a.filter((file) => file.thumb_720 !== undefined).map((file) => ({
            thumb_720: file.thumb_720, // Type assertion to satisfy the compiler
        }))) || [];
        return {
